            ...
            <div id="product-carousel" className="carousel slide" data-ride="carousel">
                <div className="carousel-inner border">
                    <div classNameName="carousel-item active">
                        <img className="w-100 h-100" src="/asset/img/product-1.jpg"alt="Image"></img>
                    </div>
                    <div className="carousel-item">
                        <img className="w-100 h-100" src="/asset/img/product-2.jpg"alt="Image"></img>
                    </div>
                    <div className="carousel-item">
                        <img className="w-100 h-100" src="/asset/img/product-3.jpg"alt="Image"></img>
                    </div>
                    <div className="carousel-item">
                        <img className="w-100 h-100" src="/asset/img/product-4.jpg"alt="Image"></img>
                    </div>
                </div>
            ...
            <div className="d-flex mb-3">
                ...
                <form>
                    <div className="custom-control custom-radio custom-control-inline">
                        <input type="radio" className="custom-control-input" id="size-1" name="size"></input>
                    ...
                    <div className="custom-control custom-radio custom-control-inline">
                        <input type="radio" className="custom-control-input" id="size-5" name="size"></input>
